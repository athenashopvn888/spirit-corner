...
export const metadata: Metadata = {
  title: "Nicotine Pouches in Downtown Ottawa | Spirit Corner Cannabis",
  description: "Visit Spirit Corner Cannabis at 251 Dalhousie St near ByWard Market or call (343) 308-8998 to ask about nicotine pouch listings. Open 24 hours for adults 19+.",
  alternates: { canonical: "https://spiritcornercannabis.com/nicotine-pouches-ottawa" },
  openGraph: {
    title: "Nicotine Pouches in Downtown Ottawa",
    description: "Call Spirit Corner Cannabis before visiting to ask about nicotine pouch listings in downtown Ottawa.",
        ...
        <div style={{ maxWidth: "1120px", margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(100%, 320px), 1fr))", gap: "24px", alignItems: "center" }}>
          <div>
            ...
            <p style={{ color: "#d1fae5", fontSize: "16px", lineHeight: 1.7, marginBottom: "18px" }}>
              Call <a href="tel:+13433088998" style={{ color: "#bbf7d0", fontWeight: 900 }}>(343) 308-8998</a>{" "}
              to ask about nicotine pouch listings before visiting 251 Dalhousie St.
            </p>
          </div>
        ...
        <div style={{ maxWidth: "960px", margin: "0 auto" }}>
          <div style={{ color: "var(--text-secondary)", fontSize: "15px", lineHeight: "1.7" }}>
            <h2 style={{ fontFamily: "var(--font-display)", fontSize: "24px", fontWeight: 900, color: "var(--text-primary)", marginBottom: "12px" }}>
              Ask About Nicotine Pouch Listings
            </h2>
            <p style={{ marginBottom: "18px" }}>
              Nicotine pouch listings can change. Call the store before travelling
              when a particular pouch brand, style, or price matters to your visit.
            </p>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "12px", marginTop: "16px" }}>
              <details style={{ background: "white", padding: "16px", borderRadius: "12px", border: "1px solid var(--border-subtle)" }}>
                <summary style={{ fontWeight: "bold", cursor: "pointer", color: "var(--text-primary)" }}>How can I ask about nicotine pouches?</summary>
                <p style={{ marginTop: "10px", color: "var(--text-secondary)", fontSize: "15px" }}>Call (343) 308-8998 before visiting to ask about current pouch listings.</p>
              </details>
              <details style={{ background: "white", padding: "16px", borderRadius: "12px", border: "1px solid var(--border-subtle)" }}>
